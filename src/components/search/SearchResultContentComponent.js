...
import { BsStar, BsFillPersonFill, BsStarFill } from 'react-icons/bs';
import {
  AiOutlinePlayCircle,
  AiFillInstagram,
  AiFillYoutube,
...
import { BiUpArrowAlt, BiPlay } from 'react-icons/bi';
    ...
    <SearchResultContentComponentBlock>
      <div className="search-channel-result-wrap">
        <div className="search-channel-star-rank-wrap">
          <div className="search-channel-favorite-star-wrap">
            <BsStar />
          </div>
          <div className="search-channel-rank-text-wrap">{index + 1}</div>
        </div>
        ...
        <div className="search-channel-info-wrap">
          <div className="search-channel-info-number">
            ...
            <p>{Math.round(info.subscriberCount / 10000)}만</p>
            <p>
              <i>
                <BiUpArrowAlt />
              </i>
              <span>{Math.round(info.subscriberCount / 10000)} </span>
            </p>
          </div>
          <div className="search-channel-info-number">
            <p>
            ...
            <p>{Math.round(info.dailyViewChange / 10000)}만</p>
            <p>
              <i>
                <BiUpArrowAlt />
              </i>
              <span>{Math.round(info.dailyViewChange / 10000)} </span>
            </p>
          </div>
          <div className="search-channel-info-number">
            <p>
            ...
            <p>{Math.round(info.averageVideoViewCount / 10000)}만</p>
            <p>&nbsp;</p>
          </div>
        </div>
