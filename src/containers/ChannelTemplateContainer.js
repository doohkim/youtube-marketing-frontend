  ...
  return (
    <ChannelListBlock>
      <div className="channel-top-block">
        <ChannelTemplate kind={channelInfo['0'].kind} key={channelInfo['0'].id}>
          <ChannelList info={channelInfo['0'].info} />
        </ChannelTemplate>
        <ChannelTemplate kind={channelInfo['1'].kind} key={channelInfo['1'].id}>
          <ChannelList info={channelInfo['1'].info} />
        </ChannelTemplate>
        <ChannelTemplate kind={channelInfo['2'].kind} key={channelInfo['2'].id}>
          <ChannelList info={channelInfo['2'].info} />
        </ChannelTemplate>
      </div>
      <div className="channel-bottom-block">
        <ChannelTemplate kind={channelInfo['3'].kind} key={channelInfo['3'].id}>
          <ChannelList info={channelInfo['3'].info} />
        </ChannelTemplate>
        <ChannelTemplate kind={channelInfo['4'].kind} key={channelInfo['4'].id}>
          <ChannelList info={channelInfo['4'].info} />
        </ChannelTemplate>
        <ChannelTemplate kind={channelInfo['5'].kind} key={channelInfo['5'].id}>
